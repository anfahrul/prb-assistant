 ...
 * Use the [MedicineReminderFragment.newInstance] factory method to
...
class MedicineReminderFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment MedicineReminderFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MedicineReminderFragment().apply {
